    ...
    function display_search_results(results) {
      ...
      window.data.then(function (loaded_data) {
        ...
        if (results.length) {
          ...
          var table =
            '<h1>Search results <a class=\"button button-clear float-right\" href=\"index.html\">Close</a></h1>' +
            "<table><thead><tr>" +
            "<th>Description</th>" +
          ...
          results.forEach(function (result) {
            ...
            table +=
              ...
              "</a></td>" +
              '<td class="nowrap">' +
              (item.phe * 1000).toFixed(2).replace(/\.?0+$/, "") +
              " mg</td>" +
              '<td class="nowrap">' +
              item.prot.toFixed(2).replace(/\.?0+$/, "") +
              " g</td>";
